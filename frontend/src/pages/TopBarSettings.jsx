...
function TopBarSettings() {
  ...
  useEffect(() => {
    axios
      ...
      .catch((err) => console.error("Error loading top bar settings", err));
  }, []);

  const handleSave = () => {
    axios
      .post(
        "http://localhost:5000/api/topbar",
        { phone, email },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("adminToken")}`,
      ...
      .then(() => {
        setSuccessMsg("Top bar updated successfully ✅");
        setTimeout(() => setSuccessMsg(""), 3000);
      })
      .catch(() => alert("Failed to update top bar"));
  };
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">Top Bar Settings</h1>
              </div>
